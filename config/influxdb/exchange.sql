CREATE DATABASE nagaexchange_exchange_production;
CREATE CONTINUOUS QUERY "trade_to_cq_1m" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "candles_1m_to_cq_1m" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "cq_5m" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "cq_15m" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "cq_30m" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "cq_1h" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "cq_2h" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "cq_4h" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "cq_6h" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "cq_12h" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "cq_1d" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "cq_3d" ON nagaexchange_exchange_production
...
END;
CREATE CONTINUOUS QUERY "cq_1w" ON nagaexchange_exchange_production
